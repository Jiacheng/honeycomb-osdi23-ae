...
VALIDATOR_DIR="${DEPLOY_ROOT}/hypervisor/validator"
RUN_TOOL="${DEPLOY_ROOT}/hypervisor/target/release/figure9"

ACCEL_DIR="/data/honeycomb-ae/run/cl-cache"
RESNET_DIR="${DEPLOY_ROOT}/build/experiments/data/resnet/binary"
ACCEL_PRECONDITION_DIR="${DEPLOY_ROOT}/experiments/accel_preconditions"
RESNET_PRECONDITION_DIR="${DEPLOY_ROOT}/experiments/resnet18_preconditions"
RESULT_DIR="${DEPLOY_ROOT}/scripts/figure9"
...
function run_resnet {
    ...
    ${RUN_TOOL} ${RESNET_DIR}/miopen_asm_conv.bin ${RESNET_PRECONDITION_DIR}/miopen_asm_conv.json miopenSp3AsmConv_v21_1_3_gfx10_fp32_stride1 >> ${STATS_FILE}
